...
/* variable:     IO_ExteriorSceneLights
 * definition:   /project/IO_CORE/CPU0/IO_CORE_CPU0_RPDO1
 * type:         BOOL
 * address:      not specified
 * constant:     False
 ...
 */
extern BOOL FAR IO_ExteriorSceneLights;
 ...
 * address:      not specified
 * constant:     False
 * comment:      I/O slave "IO_CORE/CPU0" message "RPDO1" resource "DOL3a" configured as "PIN_LO_DIGOUT"
 */
extern BOOL FAR IO_Beacon;
...
/* variable:     ExteriorSceneLightsOn
 * definition:   /project/Tera_7/Data/home_data
 * type:         BOOL
 * address:      %MX9
 * constant:     False
 * comment:      
 */
#define ExteriorSceneLightsOn (*(BOOL FARPTR)(&BYTEM[9]))
 ...
 * comment:      
 */
#define BeaconOn (*(BOOL FARPTR)(&BYTEM[14]))
