...
void vt3_event_ind_home(BYTE event)
{
	 ...
	 */
	{
	   ...
	   /*Home Screen Button Logic*/
	    ...
	    {
	        if (ExteriorSceneLightsOn == 0)
	        {
	            ExteriorSceneLightsOn = 1;
	        }
	        else
	        {
	            ExteriorSceneLightsOn = 0;
	        }        
	    }
	    ...
	    else if ((ind_screen_frame_key_F8).eventDown) 
	    {
	        if (BeaconOn == 0)
	        {
	            BeaconOn = 1;
	    ...
	    /*Strobe Pulse Pattern Logic - NOT REQUIRED*/
	/*
	...
	vt3_indicator_MultiBitmap FARPTR ind)
{
	 ...
	 * If you wish to make changes, please use vt3.
	 * 
	 *  node is:    /project/Tera_7/Screens/home/F7/Button
	 * 
	 * Omitted: the list of replaced identifiers is very long
	 */
	{
...
void vt3_event_ind_home_group_4_simple_text(
	...
	vt3_indicator_SimpleText FARPTR ind)
{
	static const STRING(3) FAR _str = { 3, 3, "CSS" };
	ind->currentValue = (PSTRING)&_str;
...
void vt3_event_ind_home_group_5_simple_text(
	...
	vt3_indicator_SimpleText FARPTR ind)
{
	static const STRING(3) FAR _str = { 3, 3, "RSS" };
	ind->currentValue = (PSTRING)&_str;
...
void vt3_event_ind_home_F6_Text_1(
	...
	vt3_indicator_SimpleText FARPTR ind)
{
	static const STRING(23) FAR _str = { 23, 23, "EXTERIOR\n SCENE\n LIGHTS" };
	ind->currentValue = (PSTRING)&_str;
	...
	vt3_indicator_MultiBitmap FARPTR ind)
{
	 ...
	 * If you wish to make changes, please use vt3.
	 * 
	 *  node is:    /project/Tera_7/Screens/home/F8/Button
	 * 
	 * Omitted: the list of replaced identifiers is very long
	 */
	{
...
void vt3_event_ind_home_F8_Text_1(
	...
	vt3_indicator_SimpleText FARPTR ind)
{
	static const STRING(6) FAR _str = { 6, 6, "BEACON" };
	ind->currentValue = (PSTRING)&_str;

	/* Warning: the code below is generated by vt3.
	 * If you wish to make changes, please use vt3.
	 * 
	 *  node is:    /project/Tera_7/Screens/home/F8/Text_1
	 * 
	 * Omitted: the list of replaced identifiers is very long
	 */
	{
