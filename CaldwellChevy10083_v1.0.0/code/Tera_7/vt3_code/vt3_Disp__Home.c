...
/* link the components of group */
static const vt3_group_E666674C_type FAR vt3_screen_ind_home_group_ind_home_group_4_childs = {
...
/* link the components of group */
static const vt3_group_E666674C_type FAR vt3_screen_ind_home_group_ind_home_group_5_childs = {
...
/* link the components of group */
static const vt3_group_20B2EF5A_type FAR vt3_screen_ind_home_group_ind_home_F8_childs = {
	&vt3_screen_union.home.F8_Button,
	&vt3_screen_union.home.F8_Text_1,
}; /* vt3_screen_ind_home_group_ind_home_F8_childs */

/* ROM configuration of indicator F8 */
static const vt3_indicator_ROM_IndicatorGroup FAR __ROM_value__ind_home_F8 = {
	/* virtual method table */ &vt3_indicator_VMT_IndicatorGroup,
	/* no event code    */ (void (*)(UINT8, vt3_indicator_IndicatorGroup FARPTR)) NULL,
	/* timer            */ 100 / VT3_TASK_PERIOD_DISPLAY,
	/* childs           */ &vt3_screen_ind_home_group_ind_home_F8_childs
}; /* __ROM_value__ind_home_F8 */

/* initialization of the runtime status of indicator F8 */
static const vt3_indicator_IndicatorGroup FAR __init_value__ind_home_F8 = {
	/* ROM parameters   */ &__ROM_value__ind_home_F8,
	/* timeout          */ 0,
	/* invalid          */ 0,
}; /* __init_value__ind_home_F8 */

/* status of indicator Button: array bitmap */
static const vt3_image FAR ind_home_F8_Button_bitmap[5] = {
	{ VT3IMG_BITMAP, vt3_BMP__GryButtonStyle1_0_0, 
			{ 255, 0, 0, 0 }, VT3_COLOR_TRANSPARENT, 
			122, 88 }, 
	{ VT3IMG_BITMAP, vt3_BMP__GrnButtonStyle1_0_0, 
	...
	{ VT3IMG_BITMAP, vt3_BMP__BluButtonStyle1_0_0, 
			{ 255, 0, 0, 0 }, { 255, 0, 0, 0 }, 
			122, 88 }, 
}; /* ind_home_F8_Button_bitmap[] */

/* ROM configuration of indicator Button */
static const vt3_indicator_ROM_MultiBitmap FAR __ROM_value__ind_home_F8_Button = {
	/* virtual method table */ &vt3_indicator_VMT_MultiBitmap,
	/* event code       */ vt3_event_ind_home_F8_Button,
	/* width            */ 122,
	/* height           */ 88,
	/* layer            */ 0,
	/* timer            */ 100 / VT3_TASK_PERIOD_DISPLAY,
	/* count            */ 5,
	/* bitmap           */ ind_home_F8_Button_bitmap,
}; /* __ROM_value__ind_home_F8_Button */

/* initialization of the runtime status of indicator Button */
static const vt3_indicator_MultiBitmap FAR __init_value__ind_home_F8_Button = {
	/* ROM parameters   */ &__ROM_value__ind_home_F8_Button,
	/* x                */ 677,
	/* y                */ 196,
	/* timeout          */ 0,
	/* currentValue     */ 0,
	...
	/* invalid          */ 0,
	/* changed          */ 0,
}; /* __init_value__ind_home_F8_Button */

/* ROM configuration of indicator Text_1 */
static const vt3_indicator_ROM_SimpleText FAR __ROM_value__ind_home_F8_Text_1 = {
	/* virtual method table */ &vt3_indicator_VMT_SimpleText,
	/* event code       */ vt3_event_ind_home_F8_Text_1,
	/* width            */ 100,
	/* height           */ 56,
	/* layer            */ 0,
	/* halign           */ VT3_ALIGN_CENTRE,
	...
	/* font             */ vt3_font_ArialBold20,
	/* timer            */ 100 / VT3_TASK_PERIOD_DISPLAY,
}; /* __ROM_value__ind_home_F8_Text_1 */

/* initialization of the runtime status of indicator Text_1 */
static const vt3_indicator_SimpleText FAR __init_value__ind_home_F8_Text_1 = {
	/* ROM parameters   */ &__ROM_value__ind_home_F8_Text_1,
	/* x                */ 686,
	/* y                */ 213,
	/* color            */ { 255, 0, 0, 0 },
	/* color_old        */ { 255, 0, 0, 0 },
	...
	/* invalid          */ 0,
	/* changed          */ 0,
}; /* __init_value__ind_home_F8_Text_1 */
...
static const vt3_screen_initializer FAR vt3_init_pointers_ind_home[] = {
	...
	{ &vt3_screen_union.home.F8, &__init_value__ind_home_F8, sizeof(vt3_indicator_IndicatorGroup) },
	{ &vt3_screen_union.home.F8_Button, &__init_value__ind_home_F8_Button, sizeof(vt3_indicator_MultiBitmap) },
	{ &vt3_screen_union.home.F8_Text_1, &__init_value__ind_home_F8_Text_1, sizeof(vt3_indicator_SimpleText) },
...
void vt3_draw_ind_home(BYTE event)
{
	...
	/* indicator "F8" of type "IndicatorGroup" */

	/* indicator "Button" of type "MultiBitmap" */

	/* draw the indicator: Button */
	vt3_draw_indicator_MultiBitmap(event, &vt3_screen_union.home.F8_Button);


	/* indicator "Text_1" of type "SimpleText" */

	/* draw the indicator: Text_1 */
	vt3_draw_indicator_SimpleText(event, &vt3_screen_union.home.F8_Text_1);
