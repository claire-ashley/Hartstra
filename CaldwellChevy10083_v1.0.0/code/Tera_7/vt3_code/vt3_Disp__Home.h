...
typedef struct vt3_screen_struct_home_t {
	...
	vt3_indicator_IndicatorGroup                 F8;
	vt3_indicator_MultiBitmap                    F8_Button;
	vt3_indicator_SimpleText                     F8_Text_1;
...
#ifndef VT3_GROUP_E666674C_TYPE
#define VT3_GROUP_E666674C_TYPE
typedef struct {
	vt3_indicator_SimpleText                 FARPTR simple_text;
} vt3_group_E666674C_type;
#endif /* VT3_GROUP_E666674C_TYPE */
...
/* this structure is used to link the components of the group /project/Tera_7/Screens/home/F8 */
#ifndef VT3_GROUP_20B2EF5A_TYPE
#define VT3_GROUP_20B2EF5A_TYPE
typedef struct {
	vt3_indicator_MultiBitmap                FARPTR Button;
