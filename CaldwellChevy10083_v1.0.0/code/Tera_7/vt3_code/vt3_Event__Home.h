...
#ifndef INCLUDE__VT3_EVENT__HOME_H
#define INCLUDE__VT3_EVENT__HOME_H
...
/* timer event handler for indicator: /project/Tera_7/Screens/home/F8/Button 
 * runs every 100ms
 */
void vt3_event_ind_home_F8_Button(
	BYTE event, 
	vt3_indicator_MultiBitmap FARPTR ind)
;

/* timer event handler for indicator: /project/Tera_7/Screens/home/F8/Text_1 
 * runs every 100ms
 */
void vt3_event_ind_home_F8_Text_1(
	BYTE event, 
	vt3_indicator_SimpleText FARPTR ind)
;

#endif /* INCLUDE__VT3_EVENT__HOME_H */
