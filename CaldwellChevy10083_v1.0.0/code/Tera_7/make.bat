...
call "C:\Program Files (x86)\VT3_8920\VT3\SCons.exe" --debug=explain --sconstruct="C:\Program Files (x86)\VT3_8920\VT3\resources\targets\TERA7\SConstruct.py" LIBPATH="C:\Program Files (x86)\VT3_8920\VT3\resources\targets\TERA7\lib" OBJPATH="C:\Users\ashlc00\DOCUME~1\Hartstra\CALDWE~1\CALDWE~1.0\code\Tera_7\__OBJE~1" MAKELIB="0" USEPDF="0" USEHB="0" USEISOBUSVT="0" USEISOBUSTC="0" USE_SEPARATE_BUILD_OF_DISPLAY_FILES="0" USE_QT_LIB="0" USER_DEFINED_CUSTOM_INDICATORS="0" TARGET="vt3_app"
